...
- **Aggiungere una modifica allo schema:** crea `db/migrations/005_<descrizione>.sql` (numero successivo all'ultimo esistente), poi `npm run db:migrate`. Lancia `npm run db:validate` per verificare che codice e schema siano allineati.
